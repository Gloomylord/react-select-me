...
var ReactSelectMe = function (_PureComponent) {
    ...
    function ReactSelectMe(props) {
        ...
        _this.pressEnterSelectItem = function (option) {
            return function (e) {
        ...
        _this.renderList = function () {
            ...
            if (rowCount) {
                listContent = options.map(function (option, index) {
                    return _this.renderOption(option, selectedOptions, {}, index);
                });
            } else {
        ...
        _this.renderOption = function (option, selectedOptions, style, index) {
            var _cs2;
            ...
            var className = (0, _classnames2.default)(s.dd__option, (_cs2 = {
                dd__selectedOption: isSelected
            }, _defineProperty(_cs2, s.dd__selectedOption, isSelected), _defineProperty(_cs2, 'dd__option', !(option.value === null)), _defineProperty(_cs2, 'group', option.group && option.value === null), _defineProperty(_cs2, 'pl', !(option.value === null) && option.group), _cs2));
                ...
                return _react2.default.createElement(
                    ...
                    { tabIndex: '0',
                        ...
                        onBlur: function onBlur() {
                            rowCount === index + 1 && _this.onToggle();
                        },
                        onKeyDown: _this.pressEnterSelectItem(option),
        ...
        _this.renderSelectedItem = function (option) {
            ...
            return _react2.default.createElement(
                ...
                multiple && _react2.default.createElement(
                    'div',
                    { className: crossIconClasses, onClick: function onClick(e) {
                            _this.onRemoveSelected(option)(e);
                        } },
                    '\xD7'
                )
            );
        ...
        _this.onToggle = function (e) {
            ...
            if (e && !(e.target.className === 'valueClear' || e.target.className === 'dd__crossIcon')) {
                ...
                if (!disabled && nextState !== opened && beforeFunc(e) !== false) {
                    var _afterFunc = nextState ? _this.onOpen : _this.onClose;
                    _this.skipEventPropagation();
                    ...
                    _this.setState({ opened: nextState }, _afterFunc);
                }
            }
        };
        ...
        _this.clearValue = function () {
            ...
            multiple ? onChange([], true) : onChange(undefined, true);
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    clearable && _react2.default.createElement(
                        'div',
                        { className: 'valueClear', onClick: this.clearValue },
                        '\xD7'
                    ),
                    this.renderIcon()
                ),
